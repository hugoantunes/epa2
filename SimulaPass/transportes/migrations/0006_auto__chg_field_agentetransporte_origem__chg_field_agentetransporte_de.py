...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AgenteTransporte.origem'
        db.alter_column('transportes_agentetransporte', 'origem_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['mundo.Quadrante']))

        # Changing field 'AgenteTransporte.destino'
        db.alter_column('transportes_agentetransporte', 'destino_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['mundo.Quadrante']))


    def backwards(self, orm):
        
        # Changing field 'AgenteTransporte.origem'
        db.alter_column('transportes_agentetransporte', 'origem_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['mundo.Quadrante']))

        # Changing field 'AgenteTransporte.destino'
        db.alter_column('transportes_agentetransporte', 'destino_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['mundo.Quadrante']))
