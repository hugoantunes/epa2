...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AgenteTransporte.tempo_percurso'
        db.add_column('transportes_agentetransporte', 'tempo_percurso', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AgenteTransporte.tempo_percurso'
        db.delete_column('transportes_agentetransporte', 'tempo_percurso')
