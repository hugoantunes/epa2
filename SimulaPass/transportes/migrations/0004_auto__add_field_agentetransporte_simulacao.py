...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AgenteTransporte.simulacao'
        db.add_column('transportes_agentetransporte', 'simulacao', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='transportes', to=orm['mundo.Simulacao']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AgenteTransporte.simulacao'
        db.delete_column('transportes_agentetransporte', 'simulacao_id')
