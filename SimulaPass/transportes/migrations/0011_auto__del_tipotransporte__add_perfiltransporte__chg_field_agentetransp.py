...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PerfilTransporte'
        db.create_table('transportes_perfiltransporte', (
        ...
        db.send_create_signal('transportes', ['PerfilTransporte'])

        # Changing field 'AgenteTransporte.tipo_transporte'
        db.alter_column('transportes_agentetransporte', 'tipo_transporte_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['transportes.PerfilTransporte']))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PerfilTransporte'
        db.delete_table('transportes_perfiltransporte')
