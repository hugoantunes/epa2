...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AgentePassageiro.origem'
        db.add_column('passageiros_agentepassageiro', 'origem', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='origem', to=orm['mundo.Quadrante']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AgentePassageiro.origem'
        db.delete_column('passageiros_agentepassageiro', 'origem_id')
    ...
    models = {
        ...
        'passageiros.agentepassageiro': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'origem': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'origem'", 'to': "orm['mundo.Quadrante']"}),
