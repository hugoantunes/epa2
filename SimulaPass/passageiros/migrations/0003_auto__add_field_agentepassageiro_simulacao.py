...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AgentePassageiro.simulacao'
        db.add_column('passageiros_agentepassageiro', 'simulacao', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='passageiros', to=orm['mundo.Simulacao']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AgentePassageiro.simulacao'
        db.delete_column('passageiros_agentepassageiro', 'simulacao_id')
