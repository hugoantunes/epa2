...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AgentePassageiro.destino'
        db.add_column('passageiros_agentepassageiro', 'destino', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='destino_passageiro', null=True, to=orm['mundo.Quadrante']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AgentePassageiro.destino'
        db.delete_column('passageiros_agentepassageiro', 'destino_id')
