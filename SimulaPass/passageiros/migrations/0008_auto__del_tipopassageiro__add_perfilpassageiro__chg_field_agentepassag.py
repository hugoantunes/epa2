...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PerfilPassageiro'
        db.create_table('passageiros_perfilpassageiro', (
        ...
        db.send_create_signal('passageiros', ['PerfilPassageiro'])

        # Changing field 'AgentePassageiro.tipo_passageiro'
        db.alter_column('passageiros_agentepassageiro', 'tipo_passageiro_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['passageiros.PerfilPassageiro']))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PerfilPassageiro'
        db.delete_table('passageiros_perfilpassageiro')
    ...
    models = {
        ...
        'passageiros.agentepassageiro': {
            ...
            'tipo_passageiro': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'agente_passageiro'", 'to': "orm['passageiros.PerfilPassageiro']"}),
        ...
        'passageiros.perfilpassageiro': {
            'Meta': {'object_name': 'PerfilPassageiro'},
        ...
        'transportes.agentetransporte': {
            ...
            'tipo_transporte': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'agente_transporte'", 'to': "orm['transportes.PerfilTransporte']"})
        },
        'transportes.perfiltransporte': {
            'Meta': {'object_name': 'PerfilTransporte'},
            'capacidade_atual': ('django.db.models.fields.IntegerField', [], {}),
