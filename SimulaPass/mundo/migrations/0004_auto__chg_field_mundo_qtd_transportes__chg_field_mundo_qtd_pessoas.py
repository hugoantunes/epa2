...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mundo.qtd_transportes'
        db.alter_column('mundo_mundo', 'qtd_transportes', self.gf('django.db.models.fields.IntegerField')(max_length=255))

        # Changing field 'Mundo.qtd_pessoas'
        db.alter_column('mundo_mundo', 'qtd_pessoas', self.gf('django.db.models.fields.IntegerField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Mundo.qtd_transportes'
        db.alter_column('mundo_mundo', 'qtd_transportes', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Mundo.qtd_pessoas'
        db.alter_column('mundo_mundo', 'qtd_pessoas', self.gf('django.db.models.fields.CharField')(max_length=255))
